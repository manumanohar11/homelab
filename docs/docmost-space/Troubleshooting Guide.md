...
See [Utility Scripts](Utility Scripts.md) for repo maintenance helpers.
...
### Symptoms: "Permission denied" in logs, can't write files
...
### Symptoms: Browser shows connection refused/timeout
...
### Symptoms: *Arr apps can't connect, real IP exposed
...
### Symptoms: Services crashing, "no space left on device"
...
### Docmost loads but collaboration/editor features are flaky
...
### Diagnosing Call Quality Problems
...
### Why is Immich excluded from Watchtower?
...
### How do I completely reset a service?
...
- See [Logging Guide](Logging Guide.md) for setup
